...
different path to ec2.ini, define the EC2_INI_PATH environment variable:
    ...
    export EC2_INI_PATH=/Users/danny.lyubenov/Repos/Task_2/ansible/inventory/ec2.ini
...
class Ec2Inventory(object):
    ...
    def add_rds_instance(self, instance, region):
        ...
        # GDR 18.09.2015
        # HACK to manufacture RDS tags
        tag = dest.split('.')[0]            # 'poc-bevo' from 'poc-bevo.cprsw9mspgvp.eu-west-1.rds.amazonaws.com'
        tag = '_'.join(tag.split('-')[1:])  # strip env 'poc-bevo' --> 'bevo'
        self.push(self.inventory, 'tag_ansible_rds_%s' % (tag,), dest)
